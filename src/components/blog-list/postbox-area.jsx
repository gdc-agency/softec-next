...
import img_1 from "@/assets/img/blog/blog-list-1.jpg";
import img_2 from "@/assets/img/blog/blog-list-3.jpg";
import thumb from "@/assets/img/blog/blog-list-2.jpg";
                            ...
                            <article key={i} className={`postbox__item ${item.cls} mb-70 transition-3`}>
                                ...
                                item.video.map((item, i) => 
                                    <div key={i} className="postbox__thumb postbox__video w-img  p-relative">
                                        ...
                                        <button onClick={() => playVideo(item.videoId)}
